      ...
      <div className="mt-4 rounded-2xl border border-gray-200 bg-gray-50 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="font-semibold text-gray-900">Leaflet Kesehatan</div>
            <div className="mt-1 text-xs text-gray-600">
              {LEAFLET.kesehatan.path}
            </div>
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="relative flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-white/80">
              Ringkasan isu kesehatan, tren data (dummy), jadwal posyandu, dan
              dokumen edukasi.
            </p>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_.8fr]">
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            <SectionHeader
              ...
              right={<Badge>{ISU.length} isu</Badge>}
            />
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              {ISU.map((isu) => (
                ...
                >
                  {/* HEADER: icon | title/subtitle | badge (fixed) */}
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      {/* Judul: jangan truncate. Pakai line-clamp 2 biar tetap rapi */}
        ...
        {/* KANAN (dibuat pendek agar seimbang) */}
        <div className="space-y-4">
          <DocumentCard />
          <CekIMT />
        </div>
      ...
      {/* Kontak Kader dipindah full-width agar layout seimbang */}
      <Card className="p-4">
        <SectionHeader
          title="Kontak Kader"
          ...
          {kaderFiltered.map((k) => (
            <div key={k.id} className="rounded-2xl border border-gray-100 p-4">
              ...
              <a
                href={toWaLink(
                  k.no_wa,
                  "Halo Bu Kader, saya ingin tanya jadwal posyandu.",
                )}
                target="_blank"
                rel="noreferrer"
      ...
      <Card className="p-4">
        ...
        {filteredJadwal.length > 8 ? (
          <div className="mt-3 text-xs text-gray-500">
            Menampilkan 8 teratas (urut tanggal). Bisa ditambah pagination
            nanti.
          </div>
        ) : null}
      </Card>
